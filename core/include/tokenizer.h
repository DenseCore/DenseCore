...
public:
   ...
   */
  static std::vector<int> Tokenize(const TransformerModel *model,
   ...
   */
  static float GetTokenScore(const TransformerModel *model,
...
private:
   ...
   */
  static int FindBestMerge(const TransformerModel *model,
