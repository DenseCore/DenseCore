...
public:
  ...
  ArenaAllocator(ArenaAllocator &&other) noexcept
      : buffer_(other.buffer_), size_(other.size_), used_(other.used_),
...
public:
   ...
   */
  void Initialize(int n_embd, int n_head, int n_head_kv, int n_layer,
                  int max_batch_tokens, int max_seq_len) {
    n_embd_ = n_embd;
    n_head_ = n_head;
