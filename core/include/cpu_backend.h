...
public:
   ...
   */
  void SynchronizeMemory(void *ptr, size_t size_bytes,
                         MemorySyncDirection direction) override {
    (void)ptr;
    (void)size_bytes;
    (void)direction;
   ...
   */
  void Quantize(const Tensor &src, QuantizedTensorView *dst,
                QuantType type) override;
