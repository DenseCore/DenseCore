...
struct Error {
    ...
    Error(ErrorCode c, std::string msg, const char* f = "", int l = 0, const char* fn = "")
 ...
 *   );
 */
#define DENSECORE_ERROR(code, msg) densecore::Error(code, msg, __FILE__, __LINE__, __FUNCTION__)
