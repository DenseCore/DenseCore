...
void AsyncCpuBackend::ConvertAndCallMatMul(const TensorView& A, const TensorView& B,
                                           TensorView& C) {
...
std::future<void> AsyncCpuBackend::MatMulAsync(KernelContext& ctx, const TensorView& A,
