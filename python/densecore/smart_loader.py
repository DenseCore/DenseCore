...
QUANT_QUALITY_ORDER = [
    ...
    "Q4_K_M", "Q4_K_S", "Q4_1", "Q4_0", "IQ4_XS",
    "Q3_K_M", "Q3_K_S", "IQ3_M",
    "Q2_K", "IQ2_M",
]
...
def recommend_quantization(
    ...
    if verbose:
        print(f"[Smart Loader] Available RAM: {available_ram_gb:.1f} GB (using {usable_ram_gb:.1f} GB with {safety_margin:.0%} safety margin)")
...
def smart_load(
    ...
    **kwargs,
    ...
    if detected_quant and min_quality:
        min_rank = QUANT_QUALITY_ORDER.index(min_quality) if min_quality in QUANT_QUALITY_ORDER else 999
